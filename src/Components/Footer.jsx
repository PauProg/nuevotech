    ...
    return (
        <div className="w-19/20 md:min-w-screen flex justify-center items-center">
            <div className="footer w-[95%] flex flex-col justify-center items-center rounded-4xl shadow-[0_0_40px_0_rgba(255,255,255,0.25)]">
                ...
                <Separador />
                <p className="text-base w-7/10 md:w-8/10 lg:w-full text-center opacity-40">© 2025 Nuevotech by PauProg | <Link to="/legal" className="text-blue-300">All Rights Reserved</Link> | Powered by ReactJS</p>
            </div>
        </div>
    );
}