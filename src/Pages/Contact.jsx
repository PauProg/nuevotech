        ...
        <div className="flex flex-col items-center justify-center w-screen">
            ...
            <div className="contacto w-9/10 lg:w-[60%] min-h-[95vh] flex justify-between items-start">
                ...
                <div className="w-full lg:w-[49%] h-full flex flex-col items-center justify-center gap-5 md:gap-10">
                    <a href="https://wa.me/34653853861" target="_blank" className="flex flex-col items-center justify-center bg-[#171733] rounded-2xl h-60 w-full border-[#8D4ACD] border-3 hover:bg-[#3A2661] transition duration-300">
