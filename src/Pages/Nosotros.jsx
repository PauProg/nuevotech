...
export const Nosotros = () => {
    ...
    return (
        <div className="nosotros min-w-screen flex flex-col justify-center items-center">
            ...
            <div className="valores w-[90%] flex-col lg:flex-row lg:w-9/10 flex gap-8 justify-center items-center flex-wrap">
                {
                    valores.map((valor) => {
                        return (
                            <div className="bloqueValor w-8/10 lg:w-1/5 h-74 bg-[#25284C] border-[#323779] border-2 rounded-lg flex flex-col justify-end items-start">
            ...
            <div className="w-[80%] flex gap-6 lg:gap-0 justify-between items-start flex-wrap">
